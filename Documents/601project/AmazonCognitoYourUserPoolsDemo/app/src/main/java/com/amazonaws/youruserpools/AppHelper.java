...
public class AppHelper {
     ...
     */
    private static final String userPoolId = "us-west-2_ChqEBY53V";

    /**
     * Add you app id
     */
    private static final String clientId = "3s37k55vdak607u7uttcht79j8";
     ...
     */
    private static final String clientSecret = "q8qpbrj3dl1i6s6vfrnvg3sod0ci3i9kf66b1pt4pooichegsjq";
