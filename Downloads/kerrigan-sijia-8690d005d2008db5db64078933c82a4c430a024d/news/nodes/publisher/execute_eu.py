...
class Publisher(BaseObject):
    ...
    def __init__(self, *a, **kw):
        ...
        THIS_MACHINE = 'eu-crawler01.eucentral.cootek.com'
        self.settings['BROKERS'] = 'eu-data01.eucentral.cootek.com:9092,eu-noah-cass01.eucentral.cootek.com:9092'
        ...
        self.producer = SimpleProducer(dstClient, async=False)
        ...
        for message in self.consumer:
            ...
            if 'html_data' in item and item['html_data']:
                ...
                for _locale in locales:
                    ...
                    publish_time = datetime.strptime(pubdate, '%Y-%m-%d')
                ...
                for _locale in locales:
                    ...
                    for each in range(0, 5):
                        try:
                            ...
                            self.logger.error('send_messages to dst_topic error,retry times %d' + each)

                    for each in range(0, 5):
                        try:
                            self.producer.send_messages(self.elk_topic, elk_msg)
                            break
                        except kafka_errors.FailedPayloadsError:
                            self.logger.error('send_messages to elk_topic error,retry times %d' + each)
