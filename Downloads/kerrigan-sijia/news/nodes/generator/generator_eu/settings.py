...
MIDDLEWARES = {
    ...
    'src.middlewares.isfallvideomaker.IsfallvideoMaker': 292,
...
ALIYUN_SERVER = 'http://news.eu.cdn.cootekservice.com'

TIME_RANGE = 3 * 24 * 3600
VIDEO_TIME_RANGE = 100 * 365 * 24 * 3600

BROKERS = 'eu-data01.eucentral.cootek.com:9092,eu-noah-cass01.eucentral.cootek.com:9092'
