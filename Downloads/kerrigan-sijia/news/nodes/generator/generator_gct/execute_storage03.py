...
if __name__ == '__main__':
    ...
    settings['DST_TOPIC_AP'] = 'gct_feedsuploader_ap'
    settings['DST_TOPIC_EU'] = 'gct_feedsuploader_eu'
    settings['DST_TOPIC_USA'] = 'gct_feedsuploader_usa'
    settings[
        'BROKERS'] = 'stream01.uscasv2.cootek.com:9092,stream02.uscasv2.cootek.com:9092,stream03.uscasv2.cootek.com:9092'

    settings['SRC_TOPIC'] = 'gct_feedsgenerator'
