...
class RealTimeFilter(FilterMiddleware):
    def __init__(self, *a, **kw):
        ...
        self.path = "feeds/generator/generator_tw/resources/real_time" if self.settings.get('TEST_MODE', False) else "resources/real_time"
    ...
    def process(self, item):
        ...
        if account.startswith('9') or u'触宝_美图' in item['raw']['raw_tags']:
            return True
