...
public class CallFragment extends Fragment {
  ...
  private Button cameraDualButton;
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    cameraDualButton =
        (Button) controlView.findViewById(R.id.button_call_dualcam);
    ...
    //add dualcamera
    cameraDualButton.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View view) {
        callEvents.onCameraDual();
      }
    });
  ...
  public void onStart() {
    ...
    if (!videoCallEnabled) {
      ...
      cameraDualButton.setVisibility(View.INVISIBLE);
    }
